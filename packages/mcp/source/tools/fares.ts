...
const FARES_FIND_CHEAPEST_ROUND_TRIP = defineTool(
...
const FARES_FIND_DAILY_FARES_IN_RANGE = defineTool(
...
const FARES_GET_CHEAPEST_PER_DAY = defineTool(
...
export const FARES_TOOLS: ToolTuple[] = [
